...
public class AlphabetLayout extends JFrame
{
    private JLabel positionLabel;
    private JButton returnButton;
    private JButton resetButton;
    private static int gridSizeRow = 4;
    private static int gridSizeCol = 7;
    private int firstCharCode = 65;
    private final int totalButton = 26;
    ...
    public AlphabetLayout(String username)
    {
    	this.username= username;
    	components();
    }
    public AlphabetLayout(){}
    ...
    {
    	AlphabetLayout alpha= new AlphabetLayout();
    	alpha.components();
    }
}