...
public class EditStory extends JFrame {
	...
	public EditStory(String username)
	{
	...
	public void getId()
	{
		try
		{
				...
				public void actionPerformed(ActionEvent e) 
				{
					...
					returnButton.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) 
						{
							// SWTICHING JFrame
							setVisible(false);
							EditStory edit= new EditStory(getValue());
					...
					btnNewButton.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) 
						{
							try
							{
							    ...
							    // QUERY
								PreparedStatement st2=conn.prepareStatement("UPDATE story set storycontent= ? where storyid= ?");
								storyContent= editorPane.getText();
								st2.setString(1, storyContent);
								st2.setInt(2,id);
								
								// EXECUTE QUERY and STORE in RESULT SET
								st2.executeUpdate();
								JOptionPane.showMessageDialog(null, "STORY UPDATED");
							}catch(Exception exp)
							{
								exp.printStackTrace();
							}
			...
			btnEdit.setForeground(new Color(255, 250, 240));
			btnEdit.setFont(new Font("PT Sans", Font.PLAIN, 13));
			btnEdit.setBounds(562, 27, 89, 38);
	...
	public void components() {
		...
		JLabel lblEnterStoryId = new JLabel("SELECT ID TO EDIT STORY");
